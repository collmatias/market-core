"""
Django settings for marketcore project.
...
# HTTPS / Secure cookies (desktop mode uses self-signed cert)
CSRF_TRUSTED_ORIGINS = [
    'https://localhost',
    'https://127.0.0.1',
]
# Dynamically trust the LAN IP if running desktop
if DEPLOYMENT_MODE == 'DESKTOP':
    ...
    try:
        ...
        _s.close()
        CSRF_TRUSTED_ORIGINS.append(f'https://{_lan_ip}')
    except Exception:
        pass
...
WSGI_APPLICATION = 'marketcore.wsgi.application'
...
if DEPLOYMENT_MODE == 'SAAS':
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'marketcore_db'),
            'USER': os.environ.get('DB_USER', 'marketcore_user'),
            'PASSWORD': os.environ.get('DB_PASS', 'marketcore_pass'),
